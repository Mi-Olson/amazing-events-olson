...
function create_cards(events, option) {
    let card = ``
...
let container_card = document.getElementById("mixCards"); //NO OLVIDAR EL DOCUMENT
container_card.innerHTML = create_cards(events, "all")
